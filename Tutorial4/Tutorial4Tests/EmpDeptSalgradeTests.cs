...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = from emp in emps select new { emp.EName, emp.Sal };
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(f => new 
            { DeptNo = f.Key, Count = f.Count() }).ToList();
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(e => new
            { DeptNo = e.Key, AvgSal = e.Average(e => e.Sal) }).ToList();
